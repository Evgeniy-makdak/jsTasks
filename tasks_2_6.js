...
console.log(
  `Номера позиций всех цифр строки ${mixedString} is [${indexNumbersArray}]`
);
console.log(
  "**************************************************************************************************"
);
...
console.log("aaa Bbb ccc Eee fff");
const defaultString2_6_6 = "aaa bbb ccc eee fff";
let transformString2_6_6 = [];
const arrayFromDefaultString2_6_6 = defaultString2_6_6.split(" ");
for (let i = 0; i < arrayFromDefaultString2_6_6.length; i++) {
  if (i % 2 === 0) {
    transformString2_6_6.push(arrayFromDefaultString2_6_6[i]);
  } else {
    transformString2_6_6.push(
      arrayFromDefaultString2_6_6[i][0].toUpperCase() +
        arrayFromDefaultString2_6_6[i].slice(
          1,
          arrayFromDefaultString2_6_6.length
        )
    );
  }
}
console.log(transformString2_6_6.join(" "));
